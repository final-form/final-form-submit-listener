...
Thanks for your interest in contributing to 🏁 Final Form Submit Listener! Please take
...
[issue tracker](https://github.com/final-form/final-form-submit-listener/issues) to
make sure your issue hasn’t already been reported.

**We use the issue tracker to keep track of bugs and improvements** to 🏁 Final
Form Submit Listener itself, its examples, and the documentation. We encourage you to
...
[StackOverflow with a `final-form-submit-listener` tag](https://stackoverflow.com/questions/tagged/final-form-submit-listener). We ask you to do this because StackOverflow has a much better job at keeping
...
[an issue](https://github.com/final-form/final-form-submit-listener/issues) to first
...
[.eslintrc](https://github.com/final-form/final-form-submit-listener/blob/master/.eslintrc).
...
you're adding new features to 🏁 Final Form Submit Listener, please include tests.
